    ...
    return [
        {
            ...
            tooltip: 'Network API Key: talks straight to the console on your network using a key created in the Network ' +
        ...
        // --- Local connection (Network API key or username/password) ---
        {
            ...
            tooltip: 'UniFi OS consoles always use port 443, and self-hosted Network Controllers default to 8443. Choose ' +
        ...
        // --- Site Manager API key ---
        {
            ...
            label: 'Console ID',
            width: 12,
            tooltip: 'The long ID of your console as it appears in the unifi.ui.com address bar when you open it: ' +
        ...
        },
        {
            ...
            width: 12,
            tooltip: 'Create one at unifi.ui.com under the API section (Site Manager API) — this is a different key from ' +
