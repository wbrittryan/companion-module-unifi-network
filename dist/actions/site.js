export function buildSiteActions(self) {
    return {
        ...
        site_set_site_connectivity: {
            ...
            description: 'Updates connectivity-related settings for the site such as uplink monitoring and internet connectivity checks.',
            options: [
        ...
        site_set_site_country: {
            ...
            description: 'Updates country-specific settings for the site including regulatory domain and channel/power restrictions.',
            options: [
        ...
        site_set_site_guest_access: {
            ...
            description: 'Updates guest network access settings including portal configuration, authentication methods, and bandwidth limits.',
            options: [
        ...
        site_set_site_locale: {
            ...
            description: 'Updates locale-specific settings for the site including language, timezone, and regional preferences.',
            options: [
        ...
        site_set_site_mgmt: {
            ...
            description: 'Updates general management settings for the site including LED control, SSH access, and SNMP settings.',
            options: [
        ...
        site_set_site_ntp: {
            ...
            description: 'Updates Network Time Protocol (NTP) settings for the site including NTP servers and time synchronization preferences.',
            options: [
        ...
        site_set_site_snmp: {
            ...
            description: 'Updates SNMP settings for the site including community strings, access controls, and monitoring configuration.',
            options: [
        ...
        site_list_self: {
            ...
            description: 'Retrieves information about the current user/admin session including permissions, roles, and access levels.',
            options: [],
            callback: async () => {
                // Every action bails out early if the module isn't currently connected to the console
                const unifi = self.unifi;
        ...
        site_set_super_identity_settings_base: {
            ...
            description: 'Updates controller-wide super administrator identity settings including authentication methods and identity providers.',
            options: [
                // unifi-api-ts parameter "payload" (required) — a raw JSON payload, typed here as text
                {
                    id: 'payload',
        ...
        site_set_super_mgmt_settings_base: {
            ...
            description: 'Updates controller-wide super administrator management settings including system-wide preferences and access controls.',
            options: [
                // unifi-api-ts parameter "payload" (required) — a raw JSON payload, typed here as text
                {
                    id: 'payload',
        ...
        site_set_super_smtp_settings_base: {
            ...
            description: 'Updates controller-wide super administrator SMTP settings including email server configuration and notification preferences.',
            options: [
                // unifi-api-ts parameter "payload" (required) — a raw JSON payload, typed here as text
                {
                    id: 'payload',
        ...
        site_stat_5minutes_site: {
            ...
            description: 'Retrieves 5-minute interval statistics for the site including bandwidth usage and client counts over time.',
            options: [
        ...
        site_stat_daily_site: {
            ...
            description: 'Retrieves daily aggregated statistics for the site including bandwidth usage and client counts over time.',
            options: [
                // unifi-api-ts parameter "start" (optional)
                {
                    id: 'start',
        ...
        site_stat_hourly_site: {
            ...
            description: 'Retrieves hourly aggregated statistics for the site including bandwidth usage and client counts over time.',
            options: [
                // unifi-api-ts parameter "start" (optional)
                {
                    id: 'start',
        ...
        site_stat_monthly_site: {
            ...
            description: 'Retrieves monthly aggregated statistics for the site including bandwidth usage and client counts over time.',
            options: [
                // unifi-api-ts parameter "start" (optional)
                {
                    id: 'start',
        ...
        site_generate_backup_site: {
            ...
            description: 'Initiates asynchronous creation of a new backup specifically for the current site (functionally identical to generate_backup).',
            options: [],
            callback: async () => {
                // Every action bails out early if the module isn't currently connected to the console
                const unifi = self.unifi;
        ...
        site_get_update_os_console: {
            ...
            description: 'Retrieves information about available UniFi OS console/controller updates including version and release notes.',
            options: [],
            callback: async () => {
                // Every action bails out early if the module isn't currently connected to the console
                const unifi = self.unifi;
