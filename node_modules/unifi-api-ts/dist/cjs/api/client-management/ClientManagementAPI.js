...
exports.ClientManagementAPI = void 0;
class ClientManagementAPI {
     ...
     */
    async list_users(site = 'default', options) {
     ...
     */
    async list_active_clients(site = 'default', include_traffic_usage = true, include_unifi_devices = true, options) {
     ...
     */
    async list_clients(site = 'default', mac, options) {
        if (mac) {
            const payload = {
     ...
     */
    async list_clients_history(site = 'default', historyhours = 8760, start, end, mac, options) {
     ...
     */
    async stat_client(site = 'default', mac, options) {
     ...
     */
    async block_sta(site = 'default', mac, options) {
        const payload = {
            cmd: 'block-sta',
            mac: mac.toLowerCase()
        };
     ...
     */
    async unblock_sta(site = 'default', mac, options) {
        if (!mac) {
            throw new Error('MAC address is required');
        }
        const payload = {
     ...
     */
    async reconnect_sta(site = 'default', mac, options) {
        if (!mac || typeof mac !== 'string') {
     ...
     */
    async forget_sta(site = 'default', macs, options) {
     ...
     */
    async edit_client_fixedip(site = 'default', client_id, use_fixedip, network_id, fixed_ip, options) {
        const payload = {
            use_fixedip
        };
        if (use_fixedip) {
     ...
     */
    async edit_client_name(site = 'default', client_id, name, options) {
        if (!name.trim()) {
     ...
     */
    async set_sta_name(site = 'default', user_id, name = '', options) {
     ...
     */
    async set_sta_note(site = 'default', user_id, note = '', options) {
        if (!user_id || typeof user_id !== 'string') {
            throw new Error('User ID cannot be empty');
        }
        const payload = {
     ...
     */
    async authorize_guest(site = 'default', mac, minutes, up, down, megabytes, ap_mac, options) {
        const payload = {
            cmd: 'authorize-guest',
            mac: mac.toLowerCase(),
            minutes
     ...
     */
    async unauthorize_guest(site = 'default', mac, options) {
        if (!mac) {
            throw new Error('MAC address is required');
        }
        const payload = {
     ...
     */
    async extend_guest_validity(site = 'default', guest_id, options) {
        const payload = {
            _id: guest_id,
            cmd: 'extend'
        };
     ...
     */
    async list_guests(site = 'default', within = 8760, options) {
        const payload = {
            within
        };
        return await this.makeRequest({
     ...
     */
    async stat_sessions(site = 'default', start, end, mac, type = 'all', options) {
     ...
     */
    async stat_sta_sessions_latest(site = 'default', mac, limit, options) {
     ...
     */
    async create_tag(name, macs, site = 'default', options) {
        const payload = {
            name
        };
     ...
     */
    async delete_tag(tag_id, site = 'default', options) {
        return await this.makeRequest({
            method: 'DELETE',
     ...
     */
    async get_tag(tag_id, site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
            url: `/api/s/{site}/rest/tag/${tag_id}`,
            ...((options === null || options === void 0 ? void 0 : options.signal) && { signal: options.signal }),
     ...
     */
    async list_tags(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async set_tagged_devices(tag_id, device_macs, site = 'default', options) {
        const payload = {
     ...
     */
    async create_voucher(minutes, count = 1, quota = 0, note = '', up, down, megabytes, site = 'default', options) {
        const payload = {
            cmd: 'create-voucher',
            expire: minutes,
            n: count,
     ...
     */
    async revoke_voucher(voucher_id, site = 'default', options) {
        const payload = {
            cmd: 'delete-voucher',
            _id: voucher_id
        };
     ...
     */
    async create_hotspotop(name, x_password, note = '', site = 'default', options) {
        const payload = {
            name,
            x_password
        };
     ...
     */
    async list_hotspotop(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
...
//# sourceMappingURL=ClientManagementAPI.js.map