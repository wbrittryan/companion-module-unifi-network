...
exports.NetworkManagementAPI = void 0;
class NetworkManagementAPI {
     ...
     */
    async create_network(payload, site = 'default', options) {
     ...
     */
    async list_networkconf(network_id, site = 'default', options) {
     ...
     */
    async delete_network(network_id, site = 'default', options) {
        return await this.makeRequest({
            method: 'DELETE',
     ...
     */
    async set_networksettings_base(network_id, payload, site = 'default', options) {
     ...
     */
    async list_routing(route_id, site = 'default', options) {
        const url = route_id
     ...
     */
    async list_portconf(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async list_portforward_stats(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async list_portforwarding(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async create_dns_record(record_type, value, key, ttl, enabled = true, site = 'default', options) {
        const payload = {
            record_type,
            value,
            key,
     ...
     */
    async list_dns_records(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
            url: '/api/s/{site}/rest/dnsrecord',
            ...((options === null || options === void 0 ? void 0 : options.signal) && { signal: options.signal }),
     ...
     */
    async delete_dns_record(record_id, site = 'default', options) {
        return await this.makeRequest({
            method: 'DELETE',
     ...
     */
    async create_dynamicdns(payload, site = 'default', options) {
        return await this.makeRequest({
            method: 'POST',
     ...
     */
    async list_dynamicdns(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
            url: '/api/s/{site}/rest/dynamicdns',
            ...((options === null || options === void 0 ? void 0 : options.signal) && { signal: options.signal }),
     ...
     */
    async set_dynamicdns(dynamicdns_id, payload, site = 'default', options) {
     ...
     */
    async create_wlan(name, x_passphrase, usergroup_id, wlangroup_id, enabled = true, hide_ssid = false, is_guest = false, security = 'open', wpa_mode = 'wpa2', wpa_enc = 'ccmp', vlan_enabled, vlan_id, uapsd_enabled = false, schedule_enabled = false, schedule = [], ap_group_ids, additional_payload = {}, site = 'default', options) {
        const payload = {
            ...additional_payload,
            name: name.trim(),
     ...
     */
    async delete_wlan(wlan_id, site = 'default', options) {
        return await this.makeRequest({
            method: 'DELETE',
     ...
     */
    async disable_wlan(wlan_id, disable, site = 'default', options) {
     ...
     */
    async list_wlan_groups(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async list_wlanconf(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async set_wlansettings(wlan_id, payload, site = 'default', options) {
     ...
     */
    async set_wlansettings_base(wlan_id, payload, site = 'default', options) {
        return await this.makeRequest({
            method: 'PUT',
            url: `/api/s/{site}/rest/wlanconf/${wlan_id.trim()}`,
            data: payload,
     ...
     */
    async list_country_codes(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async list_current_channels(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async spectrum_scan(mac, site = 'default', options) {
        const payload = {
            cmd: 'spectrum-scan',
            mac: mac.toLowerCase()
        };
     ...
     */
    async spectrum_scan_state(mac, site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async move_device(mac, site_id, site = 'default', options) {
        const payload = {
            cmd: 'move-device',
            mac: mac.toLowerCase(),
            site: site_id
...
exports.NetworkManagementAPI = NetworkManagementAPI;
//# sourceMappingURL=NetworkManagementAPI.js.map