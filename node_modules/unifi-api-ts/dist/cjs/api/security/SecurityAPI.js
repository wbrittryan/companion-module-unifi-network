...
class SecurityAPI {
     ...
     */
    async create_firewallgroup(group_name, group_type, group_members = [], site = 'default', options) {
        const payload = {
            name: group_name,
            group_type,
            group_members
     ...
     */
    async list_firewallgroups(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async list_firewallrules(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async delete_firewallgroup(group_id, site = 'default', options) {
     ...
     */
    async edit_firewallgroup(group_id, site_id, group_name, group_type, group_members = [], site = 'default', options) {
        if (!group_id || typeof group_id !== 'string') {
            throw new Error('Group ID cannot be empty');
        }
     ...
     */
    async create_radius_account(name, x_password, tunnel_type, tunnel_medium_type, vlan, site = 'default', options) {
        ...
        if (tunnel_type !== undefined)
            payload.tunnel_type = tunnel_type;
        if (tunnel_medium_type !== undefined)
     ...
     */
    async list_radius_accounts(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
            url: '/api/s/{site}/rest/account',
            ...((options === null || options === void 0 ? void 0 : options.signal) && { signal: options.signal }),
     ...
     */
    async list_radius_profiles(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async delete_radius_account(account_id, site = 'default', options) {
     ...
     */
    async set_radius_account_base(account_id, payload, site = 'default', options) {
        if (!account_id || typeof account_id !== 'string') {
            throw new Error('Account ID cannot be empty');
        }
        return await this.makeRequest({
     ...
     */
    async set_ips_settings_base(payload, site = 'default', options) {
        return await this.makeRequest({
            method: 'PUT',
     ...
     */
    async set_wlan_mac_filter(wlan_id, mac_filter_policy, mac_filter_enabled, macs, site = 'default', options) {
     ...
     */
    async set_guestlogin_settings(portal_enabled, portal_customized, redirect_enabled, redirect_url, x_password, expire_number, expire_unit, section_id, site = 'default', options) {
     ...
     */
    async set_guestlogin_settings_base(payload, section_id = '', site = 'default', options) {
     ...
     */
    async set_site_guest_access(guest_access_id, payload, site = 'default', options) {
     ...
     */
    async set_site_snmp(snmp_id, payload, site = 'default', options) {
