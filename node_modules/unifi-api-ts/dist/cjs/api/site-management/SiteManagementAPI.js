...
exports.SiteManagementAPI = void 0;
class SiteManagementAPI {
    /**
     ...
     */
    async delete_site(site_id, options) {
     ...
     */
    async set_site_name(site_name, options) {
     ...
     */
    async set_site_connectivity(connectivity_id, payload, options) {
     ...
     */
    async set_site_country(country_id, payload, options) {
     ...
     */
    async set_site_guest_access(guest_access_id, payload, options) {
     ...
     */
    async set_site_locale(locale_id, payload, options) {
     ...
     */
    async set_site_mgmt(mgmt_id, payload, options) {
     ...
     */
    async set_site_ntp(ntp_id, payload, options) {
     ...
     */
    async set_site_snmp(snmp_id, payload, options) {
     ...
     */
    async set_super_identity_settings_base(payload, options) {
        return await this.makeRequest({
            method: 'PUT',
     ...
     */
    async set_super_mgmt_settings_base(payload, options) {
        return await this.makeRequest({
            method: 'PUT',
     ...
     */
    async set_super_smtp_settings_base(payload, options) {
        return await this.makeRequest({
            method: 'PUT',
     ...
     */
    async site_leds(enable, options) {
        const payload = {
            led_enabled: enable
        };
        return await this.makeRequest({
     ...
     */
    async stat_5minutes_site(start, end, attribs, options) {
     ...
     */
    async stat_daily_site(start, end, attribs, options) {
        const current_time = Date.now();
        const end_time = end || current_time;
     ...
     */
    async stat_hourly_site(start, end, attribs, options) {
        const current_time = Date.now();
        const end_time = end || current_time;
        const start_time = start || (end_time - (7 * 24 * 3600 * 1000)); // 7 days ago
        const attributes = attribs || [
     ...
     */
    async stat_monthly_site(start, end, attribs, options) {
        const current_time = Date.now();
        const end_time = end || current_time;
     ...
     */
    async download_backup(filepath, options) {
     ...
     */
    async generate_backup_site(options) {
        const payload = {
            cmd: 'backup'
        };
        return await this.makeRequest({
     ...
     */
    async update_os_console(options) {
        const payload = {
            cmd: 'update-os'
        };
        return await this.makeRequest({
     ...
     */
    async get_update_os_console(options) {
        return await this.makeRequest({
            method: 'GET',
...
exports.SiteManagementAPI = SiteManagementAPI;
//# sourceMappingURL=SiteManagementAPI.js.map