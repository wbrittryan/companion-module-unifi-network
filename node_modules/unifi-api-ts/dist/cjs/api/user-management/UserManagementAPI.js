...
class UserManagementAPI {
     ...
     */
    async create_user(site, mac, user_group_id, name, note, is_guest, is_wired, options) {
        const new_user = {
            mac: mac.toLowerCase(),
     ...
     */
    async set_usergroup(site, client_id, group_id, options) {
     ...
     */
    async create_usergroup(site, group_name, group_dn = -1, group_up = -1, options) {
        const payload = {
            name: group_name,
     ...
     */
    async list_usergroups(site, options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async delete_usergroup(site, group_id, options) {
        return await this.makeRequest({
            method: 'DELETE',
     ...
     */
    async list_admins(site, options) {
        const payload = {
            cmd: 'get-admins'
        };
        return await this.makeRequest({
     ...
     */
    async invite_admin(site, name, email, enable_sso = true, readonly = false, device_adopt = false, device_restart = false, options) {
     ...
     */
    async assign_existing_admin(site, admin_id, readonly = false, device_adopt = false, device_restart = false, options) {
        const payload = {
            cmd: 'grant-admin',
            admin: admin_id,
            role: readonly ? 'readonly' : 'admin',
     ...
     */
    async update_admin(site, admin_id, name, email, password = '', readonly = false, device_adopt = false, device_restart = false, is_super, options) {
     ...
     */
    async revoke_admin(site, admin_id, options) {
     ...
     */
    async grant_super_admin(site, admin_id, options) {
        const payload = {
     ...
     */
    async delete_admin(site, admin_id, options) {
        const payload = {
     ...
     */
    async edit_usergroup(site, group_id, site_id, group_name, group_dn = -1, group_up = -1, options) {
        const payload = {
            _id: group_id,
            name: group_name,
            qos_rate_max_down: group_dn,
...
//# sourceMappingURL=UserManagementAPI.js.map