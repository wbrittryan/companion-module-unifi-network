...
class StatisticsAPI {
        ...
        if (originalUrl.includes('/api/s/')) {
            ...
            for (const endpoint of endpoints) {
                try {
                    ...
                    const response = await this.httpClient.request(substitutedConfig);
     ...
     */
    async stat_sysinfo(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
            url: '/api/s/{site}/stat/sysinfo',
            ...((options === null || options === void 0 ? void 0 : options.signal) && { signal: options.signal }),
        }, site);
    }
    /**
     * List health metrics
     ...
     */
    async list_health(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async stat_full_status(site = 'default', options) {
     ...
     */
    async check_controller_update(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async check_firmware_update(site = 'default', options) {
        const payload = {
     ...
     */
    async list_events(historyhours = 720, start, end, limit = 3000, site = 'default', options) {
        const payload = {
            _limit: limit,
            within: historyhours
        };
     ...
     */
    async list_alarms(payload = {}, site = 'default', options) {
     ...
     */
    async count_alarms(archived, site = 'default', options) {
     ...
     */
    async stat_5minutes_site(start, end, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_5minutes_aps(start, end, mac, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_5minutes_gateway(start, end, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_5minutes_user(mac, start, end, attribs, site = 'default', options) {
        const payload = {};
        if (mac)
            payload.mac = mac.toLowerCase();
        if (start !== undefined)
     ...
     */
    async stat_hourly_aps(start, end, mac, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_hourly_gateway(start, end, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_hourly_site(start, end, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_hourly_user(mac, start, end, attribs, site = 'default', options) {
        const payload = {};
        if (mac)
            payload.mac = mac.toLowerCase();
        if (start !== undefined)
     ...
     */
    async stat_daily_aps(start, end, mac, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_daily_gateway(start, end, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_daily_site(start, end, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_daily_user(mac, start, end, attribs, site = 'default', options) {
        const payload = {};
        if (mac)
            payload.mac = mac.toLowerCase();
        if (start !== undefined)
     ...
     */
    async stat_monthly_aps(start, end, mac, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_monthly_gateway(start, end, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_monthly_site(start, end, attribs, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_monthly_user(mac, start, end, attribs, site = 'default', options) {
        const payload = {};
        if (mac)
            payload.mac = mac.toLowerCase();
        if (start !== undefined)
     ...
     */
    async stat_allusers(historyhours = 8760, site = 'default', options) {
        const payload = {
            within: historyhours
        };
        return await this.makeRequest({
     ...
     */
    async stat_client(mac, site = 'default', options) {
     ...
     */
    async stat_auths(start, end, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_sessions(start, end, mac, type = 'all', site = 'default', options) {
        const payload = {
            type: type.trim()
        };
        if (start !== undefined)
     ...
     */
    async stat_ips_events(start, end, limit, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_speedtest_results(start, end, site = 'default', options) {
        const payload = {};
        if (start !== undefined)
            payload.start = start;
        if (end !== undefined)
     ...
     */
    async stat_payment(within, site = 'default', options) {
     ...
     */
    async stat_voucher(create_time, site = 'default', options) {
        const payload = {};
     ...
     */
    async archive_alarm(alarm_id, site = 'default', options) {
     ...
     */
    async cmd_stat(command, site = 'default', options) {
     ...
     */
    async list_dashboard(five_minutes = false, site = 'default', options) {
     ...
     */
    async list_dpi_stats(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async list_dpi_stats_filtered(type = 'by_app', cat_filter, site = 'default', options) {
        const payload = {
            type
        };
        if (cat_filter) {
     ...
     */
    async stat_status(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async get_system_log(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async list_extension(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async list_fingerprint_devices(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
     ...
     */
    async list_rogueaps(within = 24, site = 'default', options) {
        const payload = {
            within
        };
        return await this.makeRequest({
     ...
     */
    async list_known_rogueaps(site = 'default', options) {
        return await this.makeRequest({
            method: 'GET',
