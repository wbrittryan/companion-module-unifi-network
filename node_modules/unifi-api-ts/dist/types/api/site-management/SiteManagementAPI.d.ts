...
export declare class SiteManagementAPI {
    private httpClient;
    /**
     ...
     */
    create_site(description: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     * Delete a site
     ...
     */
    delete_site(site_id: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_site_name(site_name: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_site_connectivity(connectivity_id: string, payload: any, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_site_country(country_id: string, payload: any, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_site_guest_access(guest_access_id: string, payload: any, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_site_locale(locale_id: string, payload: any, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_site_mgmt(mgmt_id: string, payload: any, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_site_ntp(ntp_id: string, payload: any, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_site_snmp(snmp_id: string, payload: any, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     * List site settings
     ...
     */
    set_super_identity_settings_base(payload: any, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_super_mgmt_settings_base(payload: any, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_super_smtp_settings_base(payload: any, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    site_leds(enable: boolean, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     * Turn off site LEDs
     ...
     */
    stat_5minutes_site(start?: number, end?: number, attribs?: string[], options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    stat_daily_site(start?: number, end?: number, attribs?: string[], options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    stat_hourly_site(start?: number, end?: number, attribs?: string[], options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    stat_monthly_site(start?: number, end?: number, attribs?: string[], options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    download_backup(filepath: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     * Generate backup
     ...
     */
    get_update_os_console(options?: {
        signal?: AbortSignal;
    }): Promise<any>;
}
//# sourceMappingURL=SiteManagementAPI.d.ts.map