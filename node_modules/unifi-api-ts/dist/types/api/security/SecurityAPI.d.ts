...
export declare class SecurityAPI {
     ...
     */
    create_firewallgroup(group_name: string, group_type: 'address-group' | 'ipv6-address-group' | 'port-group', group_members?: string[], site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    list_firewallgroups(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     * List firewall rules
     ...
     */
    list_firewallrules(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    delete_firewallgroup(group_id: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     * Edit firewall group
     ...
     */
    edit_firewallgroup(group_id: string, site_id: string, group_name: string, group_type: 'address-group' | 'ipv6-address-group' | 'port-group', group_members?: string[], site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    create_radius_account(name: string, x_password: string, tunnel_type?: number, tunnel_medium_type?: number, vlan?: number, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    list_radius_accounts(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    list_radius_profiles(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    delete_radius_account(account_id: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_radius_account_base(account_id: string, payload: any, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_ips_settings_base(payload: any, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     * Set WLAN MAC filter
     ...
     */
    set_wlan_mac_filter(wlan_id: string, mac_filter_policy: 'allow' | 'deny', mac_filter_enabled: boolean, macs: string[], site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_guestlogin_settings(portal_enabled: boolean, portal_customized: boolean, redirect_enabled: boolean, redirect_url: string, x_password: string, expire_number: number, expire_unit: number, section_id: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_guestlogin_settings_base(payload: any, section_id?: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_site_guest_access(guest_access_id: string, payload: any, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_site_snmp(snmp_id: string, payload: any, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
}
//# sourceMappingURL=SecurityAPI.d.ts.map