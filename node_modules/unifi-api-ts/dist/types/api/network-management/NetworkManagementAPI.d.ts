...
export declare class NetworkManagementAPI {
    private httpClient;
     ...
     */
    create_network(payload: any, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    list_networkconf(network_id?: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     * Delete network
     ...
     */
    delete_network(network_id: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_networksettings_base(network_id: string, payload: any, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     * List routing rules
     ...
     */
    list_routing(route_id?: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    list_portconf(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    list_portforward_stats(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    list_portforwarding(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     * Create DNS record
     ...
     */
    create_dns_record(record_type: 'A' | 'AAAA' | 'MX' | 'TXT' | 'SRV' | 'NS', value: string, key: string, ttl?: number, enabled?: boolean, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     * List DNS records
     ...
     */
    list_dns_records(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     * Delete DNS record
     ...
     */
    delete_dns_record(record_id: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    create_dynamicdns(payload: any, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    list_dynamicdns(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    set_dynamicdns(dynamicdns_id: string, payload: any, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    create_wlan(name: string, x_passphrase: string, usergroup_id: string, wlangroup_id: string, enabled?: boolean, hide_ssid?: boolean, is_guest?: boolean, security?: string, wpa_mode?: string, wpa_enc?: string, vlan_enabled?: boolean, vlan_id?: string, uapsd_enabled?: boolean, schedule_enabled?: boolean, schedule?: any[], ap_group_ids?: string[], additional_payload?: any, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     * Delete WLAN
     ...
     */
    delete_wlan(wlan_id: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     * Disable WLAN
     ...
     */
    disable_wlan(wlan_id: string, disable: boolean, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     * List WLAN groups
     ...
     */
    list_wlan_groups(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    list_wlanconf(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     * Set WLAN settings
     ...
     */
    set_wlansettings(wlan_id: string, payload: any, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     ...
     */
    set_wlansettings_base(wlan_id: string, payload: any, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     * List country codes
     ...
     */
    list_country_codes(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     ...
     */
    list_current_channels(site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     * Spectrum scan
     ...
     */
    spectrum_scan(mac: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
    /**
     * Spectrum scan state
     ...
     */
    spectrum_scan_state(mac: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<any>;
    /**
     * Move device
     ...
     */
    move_device(mac: string, site_id: string, site?: string, options?: {
        signal?: AbortSignal;
    }): Promise<boolean>;
}
//# sourceMappingURL=NetworkManagementAPI.d.ts.map