...
export type CompanionPresetDefinition<TManifest extends InstanceTypes = InstanceTypes> = CompanionSimplePresetDefinition<TManifest>;
 ...
 */
export type CompanionPresetAction<TActionManifest extends Record<string, CompanionActionSchema<CompanionOptionValues>> = Record<string, CompanionActionSchema<CompanionOptionValues>>> = {
