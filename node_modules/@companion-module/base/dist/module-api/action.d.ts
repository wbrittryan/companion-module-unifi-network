...
export interface CompanionActionDefinition<TOptions extends CompanionOptionValues = CompanionOptionValues> {
     ...
     */
    learn?: (action: CompanionActionEvent<TOptions>, context: CompanionActionContext) => Partial<TOptions> | undefined | Promise<Partial<TOptions> | undefined>;
    /**
 ...
 */
export type CompanionActionDefinitions<Tschemas extends Record<string, CompanionActionSchema<CompanionOptionValues>> = Record<string, CompanionActionSchema<CompanionOptionValues>>> = {
