...
export interface CompanionFeedbackDefinitionBase<TOptions extends CompanionOptionValues = CompanionOptionValues> {
     ...
     */
    learn?: (feedback: CompanionFeedbackInfo<TOptions>, context: CompanionFeedbackContext) => Partial<TOptions> | undefined | Promise<Partial<TOptions> | undefined>;
    /**
...
export interface CompanionBooleanFeedbackDefinition<TOptions extends CompanionOptionValues = CompanionOptionValues> extends CompanionFeedbackDefinitionBase<TOptions> {
    ...
    callback: (feedback: CompanionFeedbackBooleanEvent<TOptions>, context: CompanionFeedbackContext) => boolean | Promise<boolean>;
    /**
...
export interface CompanionValueFeedbackDefinition<TOptions extends CompanionOptionValues = CompanionOptionValues> extends CompanionFeedbackDefinitionBase<TOptions> {
    ...
    type: 'value';
    /** Called to get the feedback value */
    callback: (feedback: CompanionFeedbackValueEvent<TOptions>, context: CompanionFeedbackContext) => JsonValue | Promise<JsonValue>;
}
/**
...
export interface CompanionAdvancedFeedbackDefinition<TOptions extends CompanionOptionValues = CompanionOptionValues> extends CompanionFeedbackDefinitionBase<TOptions> {
    ...
    type: 'advanced';
    /** Called to get the feedback value */
    callback: (feedback: CompanionFeedbackAdvancedEvent<TOptions>, context: CompanionFeedbackContext) => CompanionAdvancedFeedbackResult | Promise<CompanionAdvancedFeedbackResult>;
}
/**
