...
// Auto-generated from unifi-api-ts's StatisticsAPI class: every public method it exposes becomes one
// Companion action below, named "Statistics: <action>". Do not hand-edit call sites here without also
// checking unifi-api-ts's StatisticsAPI.d.ts, since the argument order must match it exactly.

// The shape of each action's options, so Companion's editor UI and the callback below stay in sync.
export type StatsActionsSchema = {
	// Statistics: Get System Info — options Companion stores for this action's button
	stats_stat_sysinfo: {
		options: Record<string, never>
	}
	// Statistics: List Health Metrics — options Companion stores for this action's button
	stats_list_health: {
		options: Record<string, never>
	}
	// Statistics: Get Full Status — options Companion stores for this action's button
	stats_stat_full_status: {
		options: Record<string, never>
	}
	// Statistics: Check Controller Update — options Companion stores for this action's button
	stats_check_controller_update: {
		options: Record<string, never>
	}
	// Statistics: Check Firmware Update — options Companion stores for this action's button
	stats_check_firmware_update: {
		options: Record<string, never>
	}
	// Statistics: List Events — options Companion stores for this action's button
	stats_list_events: {
		options: {
			historyhours: number
			start: number
	...
	// Statistics: List Alarms — options Companion stores for this action's button
	stats_list_alarms: {
		options: {
			payload: string
		}
	}
	// Statistics: Count Alarms — options Companion stores for this action's button
	stats_count_alarms: {
		options: {
			archived: boolean
		}
	}
	// Statistics: Get 5-Minute Site Stats — options Companion stores for this action's button
	...
	// Statistics: Get 5-Minute AP Stats — options Companion stores for this action's button
	...
	// Statistics: Get 5-Minute Gateway Stats — options Companion stores for this action's button
	...
	// Statistics: Get 5-Minute User Stats — options Companion stores for this action's button
	...
	// Statistics: Get Hourly AP Stats — options Companion stores for this action's button
	...
	// Statistics: Get Hourly Gateway Stats — options Companion stores for this action's button
	...
	// Statistics: Get Hourly Site Stats — options Companion stores for this action's button
	...
	// Statistics: Get Hourly User Stats — options Companion stores for this action's button
	...
	// Statistics: Get Daily AP Stats — options Companion stores for this action's button
	...
	// Statistics: Get Daily Gateway Stats — options Companion stores for this action's button
	...
	// Statistics: Get Daily Site Stats — options Companion stores for this action's button
	...
	// Statistics: Get Daily User Stats — options Companion stores for this action's button
	...
	// Statistics: Get Monthly AP Stats — options Companion stores for this action's button
	...
	// Statistics: Get Monthly Gateway Stats — options Companion stores for this action's button
	...
	// Statistics: Get Monthly Site Stats — options Companion stores for this action's button
	...
	// Statistics: Get Monthly User Stats — options Companion stores for this action's button
	...
	// Statistics: Get All Users Stats — options Companion stores for this action's button
	stats_stat_allusers: {
		options: {
			historyhours: number
		}
	}
	// Statistics: Get Client Stats — options Companion stores for this action's button
	stats_stat_client: {
		options: {
			mac: string
		}
	}
	// Statistics: Get Auth Events — options Companion stores for this action's button
	stats_stat_auths: {
		options: {
			start: number
			end: number
	...
	// Statistics: Get Sessions — options Companion stores for this action's button
	stats_stat_sessions: {
		options: {
			start: number
			end: number
	...
	// Statistics: Get IPS Events — options Companion stores for this action's button
	...
	// Statistics: Get Speed Test Results — options Companion stores for this action's button
	...
	// Statistics: Get Payments — options Companion stores for this action's button
	stats_stat_payment: {
		options: {
			within: number
		}
	}
	// Statistics: Get Voucher Stats — options Companion stores for this action's button
	stats_stat_voucher: {
		options: {
			create_time: number
		}
	}
	// Statistics: Archive Alarm — options Companion stores for this action's button
	stats_archive_alarm: {
		options: {
			alarm_id: string
		}
	}
	// Statistics: Execute Stat Command — options Companion stores for this action's button
	stats_cmd_stat: {
		options: {
			command: string
		}
	}
	// Statistics: List Dashboard — options Companion stores for this action's button
	stats_list_dashboard: {
		options: {
			five_minutes: boolean
		}
	}
	// Statistics: List DPI Stats — options Companion stores for this action's button
	stats_list_dpi_stats: {
		options: Record<string, never>
	}
	// Statistics: List Filtered DPI Stats — options Companion stores for this action's button
	...
	// Statistics: Get Status — options Companion stores for this action's button
	stats_stat_status: {
		options: Record<string, never>
	}
	// Statistics: Get System Log — options Companion stores for this action's button
	stats_get_system_log: {
		options: Record<string, never>
	}
	// Statistics: List Extensions — options Companion stores for this action's button
	stats_list_extension: {
		options: Record<string, never>
	}
	// Statistics: List Fingerprint Devices — options Companion stores for this action's button
	stats_list_fingerprint_devices: {
		options: Record<string, never>
	}
	// Statistics: List Rogue APs — options Companion stores for this action's button
	stats_list_rogueaps: {
		options: {
			within: number
		}
	}
	// Statistics: List Known Rogue APs — options Companion stores for this action's button
	stats_list_known_rogueaps: {
		options: Record<string, never>
	}
}

export function buildStatsActions(self: ModuleInstance): CompanionActionDefinitions<StatsActionsSchema> {
	return {
		...
		stats_stat_full_status: {
			...
			description:
				'Retrieves comprehensive status information from the UniFi Controller, including detailed system status, configuration, and operational data.',
			options: [],
			callback: async () => {
				// Every action bails out early if the module isn't currently connected to the console
				const unifi = self.unifi
		...
		stats_check_controller_update: {
			...
			description:
				'Checks for available UniFi Controller software updates and returns information about the latest available version.',
			options: [],
			callback: async () => {
				// Every action bails out early if the module isn't currently connected to the console
				const unifi = self.unifi
		...
		stats_list_events: {
			...
			description:
				'Retrieves system events from the UniFi Controller with optional time filtering, such as device connections, disconnections, configuration changes, and system alerts.',
			options: [
		...
		stats_list_alarms: {
			...
			description:
				'Retrieves system alarms from the UniFi Controller representing significant events that require attention.',
			options: [
		...
		stats_stat_5minutes_site: {
			...
			description:
				'Retrieves 5-minute interval statistics for the entire site, covering network usage, performance, and activity.',
			options: [
				// unifi-api-ts parameter "start" (optional)
				{
					id: 'start',
		...
		stats_stat_5minutes_gateway: {
			...
			description:
				'Retrieves 5-minute interval statistics for the gateway/router, covering WAN/LAN traffic, routing, and performance.',
			options: [
				// unifi-api-ts parameter "start" (optional)
				{
					id: 'start',
		...
		stats_stat_sessions: {
			...
			description:
				'Retrieves user session information with optional filtering by time range, MAC address, or session type.',
			options: [
				// unifi-api-ts parameter "start" (optional)
				{
					id: 'start',
		...
		stats_cmd_stat: {
			...
			description:
				'Executes a system statistics command, currently supporting a DPI (Deep Packet Inspection) reset operation.',
			options: [
		...
		stats_list_dashboard: {
			...
			description:
				'Retrieves dashboard statistics and metrics for the UniFi site, in standard or 5-minute interval resolution.',
			options: [
		...
		stats_get_system_log: {
			...
			description:
				'Retrieves system log entries from the UniFi Controller, providing access to system events, errors, and operational messages.',
			options: [],
			callback: async () => {
				// Every action bails out early if the module isn't currently connected to the console
				const unifi = self.unifi
		...
		stats_list_extension: {
			...
			description:
				'Retrieves information about UniFi Controller extensions and add-ons, including installed plugins, modules, and additional functionality.',
			options: [],
			callback: async () => {
				// Every action bails out early if the module isn't currently connected to the console
				const unifi = self.unifi
		...
		stats_list_known_rogueaps: {
			...
			description:
				'Retrieves a list of known (whitelisted) rogue access points that have been marked as safe or authorized.',
			options: [],
			callback: async () => {
				// Every action bails out early if the module isn't currently connected to the console
				const unifi = self.unifi
